    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          aria-label="Close"
          className="absolute top-4 right-4 z-20 w-9 h-9 flex items-center justify-center border border-stone hover:border-primary text-ink/60 hover:text-primary transition-colors duration-200"
        >
          ...
          <div className="p-8 lg:p-10 flex flex-col">
            ...
            <div className="mb-6">
              ...
              {price && (
                <div className="flex items-baseline gap-2 mb-4">
                  ...
                  <p className="font-sans text-xs text-ink/60">per night</p>
                  {room.tag === 'Standard' && (
                    <p className="font-sans text-[10px] text-primary">· Bed & Breakfast</p>
                  )}
                </div>
              )}
            ...
            <div className="space-y-5 flex-1">
              {(room.amenities || []).map((group) => (
                <div key={group.label}>
                  <p className="font-sans text-[9px] uppercase tracking-[0.35em] text-ink/60 mb-2.5">{group.label}</p>
            ...
            <div className="mt-8 pt-6 border-t border-stone flex flex-col sm:flex-row gap-3">
              ...
              <a
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 py-4 border border-stone text-ink/70 font-sans font-medium tracking-widest uppercase text-[10px] hover:border-primary hover:text-primary transition-colors duration-200"
              >
